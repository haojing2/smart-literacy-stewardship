...
class MockResearchAssistant(ResearchAssistantProvider):
    ...
    async def generate_teaching_resource(
        ...
        payload = copy.deepcopy(RESOURCE_OUTPUT_TEMPLATES[request.resource_type])
        ...
        payload["changeSummary"] = "Generated by Mock AI"
        return TeachingResourceGenerationResult.model_validate(payload)
