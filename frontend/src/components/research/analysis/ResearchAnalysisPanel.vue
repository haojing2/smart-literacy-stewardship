...
<template>
  <section class="analysis-panel">
    ...
    <div class="evidence-generation">
      <template v-if="evidenceGenerated"><p>证据卡已生成</p><el-button link type="primary" @click="$emit('generateEvidence')">查看证据卡</el-button></template>
