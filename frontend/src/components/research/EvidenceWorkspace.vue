...
<style scoped>
.evidence-workspace { height: 100%; min-width: 0; min-height: 0; overflow: hidden; border: 1px solid #eaecf0; border-radius: 12px; background: #fff; box-shadow: 0 1px 3px rgb(16 24 40 / 4%); }.workspace-tabs { display: flex; height: 100%; min-height: 0; flex-direction: column; }.workspace-tabs :deep(.el-tabs__header) { flex: none; margin: 0 18px 16px; }.workspace-tabs :deep(.el-tabs__nav-wrap::after) { height: 1px; background: #eaecf0; }.workspace-tabs :deep(.el-tabs__item) { height: 48px; color: #667085; font-size: 13px; }.workspace-tabs :deep(.el-tabs__item.is-active) { color: #1677ff; }.workspace-tabs :deep(.el-tabs__active-bar) { height: 2px; }.workspace-tabs :deep(.el-tabs__content) { flex: 1; min-height: 0; overflow-x: hidden; overflow-y: auto; }.workspace-tabs :deep(.el-tab-pane) { height: auto; min-height: 100%; overflow: visible; }.evidence-tab-label { position: relative; }.evidence-tab-label i { position: absolute; top: -1px; right: -8px; width: 6px; height: 6px; border-radius: 50%; background: #1677ff; }.evidence-empty { display: flex; min-height: 420px; align-items: center; justify-content: center; flex-direction: column; padding: 30px 20px; text-align: center; }.evidence-empty>div { display: grid; width: 40px; height: 40px; place-items: center; border-radius: 10px; color: #667085; background: #f5f7fa; }.evidence-empty h3 { margin: 14px 0 7px; color: #344054; font-size: 15px; }.evidence-empty p { max-width: 250px; margin: 0; color: #98a2b3; font-size: 12px; line-height: 1.7; }.evidence-empty span { margin-top: 14px; color: #667085; font-size: 12px; }.evidence-loading { padding: 8px 18px; }.evidence-loading p { color: #667085; font-size: 12px; }
</style>
